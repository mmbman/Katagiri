...
- “Hairsbreadth deviation” also appears in the *Song of the Jewel Mirror Awareness*. Katagiri Roshi’s commentary on that is not publicly available at this time. However, references to the general idea of *separation* – and its opposite, which would be *samadhi*, “one-pointedness,” or “total acceptance,” etc. – are probably too numerous to cite. A random example where these are discussed would be [“*Blue Cliff Record* Case 50: Yun Men’s Every Atom Samadhi”](1984-01-04-Blue-Cliff-Record-Case-50) – the talk I happen to be transcribing at the time of writing.
