...
So you want to do something right now: you can hope. You can hope that I want to do something. You cannot expect a different result [...] but nevertheless, you will have to do, and also, you cannot help [doing]. *You have to do* means somebody orders you to do; at that time, you’re mad at [them]. But it’s not [that]; principle is not somebody ordering you. Principle is something [where] you have to be just present there and do something. That’s all we have to do. 
