...
*Individual karma* is individual character. There is a certain character in everything, even the table, and the floor, and the microphone. There is a particular character in the microphone which is different from the character in the table. So everything has individual karma, [not just] human beings. 
...
So there are two different karmas in Buddhism generally, individual karma and non-individual karma. And 

Those two [kinds of] karma are produced by three kinds of activity: *body* or physical deeds; [*speech*] or linguistic deeds; and also *mind*, mental deeds.
